  ...
  */
  ...
  function createVue3Component(vueObj) {
    ...
    class VueFactory extends React__default["default"].Component {
      ...
      render() {
        return React__default["default"].createElement("div", { ref: this.domRef });
      }
    }
    return VueFactory;
  }
  ...
  var uniInfoCard_vue_vue_type_style_index_0_scoped_true_lang = "";
  ...
  const _sfc_main = {
    ...
    computed: {
      title() {
        return this.componentProperties && this.componentProperties.data && this.componentProperties.data.title || "amis \u662F\u4E00\u4E2A\u4F4E\u4EE3\u7801\u524D\u7AEF\u6846\u67B6\uFF0C\u5B83\u4F7F\u7528 JSON \u914D\u7F6E\u6765\u751F\u6210\u9875\u9762\uFF0C\u53EF\u4EE5\u51CF\u5C11\u9875\u9762\u5F00\u53D1\u5DE5\u4F5C\u91CF\uFF0C\u6781\u5927\u63D0\u5347\u6548\u7387\u3002";
      },
      backgroundImage() {
        return this.componentProperties && this.componentProperties.data && this.componentProperties.data.backgroundImage || "https://search-operate.cdn.bcebos.com/64c279f23794a831f9a8e7a4e0b722dd.jpg";
      },
      img_count() {
        return this.componentProperties && this.componentProperties.data && this.componentProperties.data.img_count || 1;
      },
      comment_count() {
        return this.componentProperties && this.componentProperties.data && this.componentProperties.data.comment_count;
      }
    },
    mounted() {
    ...
    methods: {
      agreeDataFormat(agreeData) {
        if (agreeData && agreeData <= 9999) {
          ...
          return `${Math.floor(agreeData / 1e3) / 10}w`;
        }
      }
    }
  };
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", { class: "news-card" }, [
      vue.createElementVNode("div", { class: "news-title" }, vue.toDisplayString($options.title), 1),
      vue.createElementVNode("div", { class: "item-imgbox" }, [
        vue.createElementVNode("div", {
          class: "news-img",
          style: vue.normalizeStyle({ backgroundImage: "url(" + $options.backgroundImage + ")" })
        }, null, 4),
        $options.img_count > 0 ? (vue.openBlock(), vue.createElementBlock("div", {
          key: 0,
          class: "img-count"
        }, vue.toDisplayString($options.img_count), 1)) : vue.createCommentVNode("v-if", true)
      ]),
      vue.createElementVNode("div", { class: "news-info" }, [
        vue.createElementVNode("div", { class: "left media-mark" }, "\u7231\u901F\u642D \xB7 \u4F4E\u4EE3\u7801\u5E73\u53F0"),
        vue.createElementVNode("div", { class: "cmt-num right" }, vue.toDisplayString($options.agreeDataFormat($options.comment_count) || 0) + " \u8BC4 ", 1)
      ])
    ]);
  }
  var InfoCard = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-61599b84"]]);
