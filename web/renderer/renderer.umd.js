...
(function(global2, factory) {
  ...
  */
  ...
  const uniInfoCard_vue_vue_type_style_index_0_scoped_dab56e24_lang = "";
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", { class: "news-card" }, [
      ...
      vue.createElementVNode("div", { class: "item-imgbox" }, [
        ...
        $options.img_count > 0 ? (vue.openBlock(), vue.createElementBlock(
          "div",
          {
            key: 0,
            class: "img-count"
          },
          vue.toDisplayString($options.img_count),
          1
          /* TEXT */
        )) : vue.createCommentVNode("v-if", true)
      ]),
      vue.createElementVNode("div", { class: "news-info" }, [
        vue.createElementVNode("div", { class: "left media-mark" }, "爱速搭 · 低代码平台"),
        vue.createElementVNode(
          "div",
          { class: "cmt-num right" },
          vue.toDisplayString($options.agreeDataFormat($options.comment_count) || 0) + " 评 ",
          1
          /* TEXT */
        )
      ])
  ...
  const InfoCard = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-dab56e24"]]);
